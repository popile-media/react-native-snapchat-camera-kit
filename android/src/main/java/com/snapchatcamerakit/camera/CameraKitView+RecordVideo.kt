...
fun CameraKitView.startRecording(options: ReadableMap, promise: Promise) {
    ...
    val mediaCaptureCallback: MediaCaptureCallback = object : MediaCaptureCallback {
    ...
    val captureCloseable = MediaCapture(
