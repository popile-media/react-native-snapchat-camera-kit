...
fun invokeOnLensChanged(view: CameraKitView, status: String, lens: Lens?) {
...
fun invokeOnPhotoTaken(view: CameraKitView, data: WritableMap) {
...
fun invokeOnVideoRecordingFinished(view: CameraKitView, uri: String) {
...
fun invokeOnError(view: CameraKitView, error: Throwable) {
