...
This library under development, if you found a bug, please open an issue from [here](https://github.com/popile-media/react-native-snapchat-camera-kit/issues/new/choose).
